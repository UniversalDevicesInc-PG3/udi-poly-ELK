...
class AreaNode(BaseNode):
    ...
    drivers = [
        # status
        {'driver': 'ST',  'value': 0, 'uom': 25, "name": "Alarm Status"},
        {'driver': 'GV0',  'value': 0, 'uom': 25, "name": "Armed Status"},
        {'driver': 'GV1',  'value': 0, 'uom': 25, "name": "Arm Up State"},
        {'driver': 'GV2',  'value': 0, 'uom': 25, "name": "Chime Mode"},
        {'driver': 'GV3',  'value': 0, 'uom': 25, "name": "Zones Violated"},
        {'driver': 'GV4',  'value': 0, 'uom': 25, "name": "Zones Bypassed"},
        {'driver': 'GV5',  'value': 0, 'uom': 2, "name": "Poll Voltages"},
        {'driver': 'GV6',  'value': 0, 'uom': 25, "name": "Last User"},
        {'driver': 'GV7',  'value': 0, 'uom': 25, "name": "Last User Keyupad"},
        {'driver': 'GV8',  'value': 0, 'uom': 25, "name": "Last Violated Zone"},
        {'driver': 'GV9',  'value': 0, 'uom': 25, "name": "Last Triggered Zone"},
        {'driver': 'GV10',  'value': 1, 'uom': 2, "name": "Additional Trigger"},
    ]
    id = 'area'
    commands = {
