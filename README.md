...
## Version History
- 0.5.4: 04/05/2021
  - [Can not turn off "use off node"](https://github.com/jimboca/udi-poly-elk/issues/56)
  - [Keypad: Allow showing C or F](https://github.com/jimboca/udi-poly-elk/issues/53)
  - [Keypad: Only show temperature if the keypad has a sensor](https://github.com/jimboca/udi-poly-elk/issues/52)
    - I can not test this, so I need someone with a temperature sensor in a keypad to confirm
  - [Violated Zone Reporting Armed Stay Mode vs Elk M1 Reporting](https://github.com/jimboca/udi-poly-elk/issues/46)
